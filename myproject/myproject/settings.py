...
# Use PostgreSQL when DATABASE_URL is set (e.g. Neon). Falls back to SQLite
# for local development when the variable is absent.
...
FILE_UPLOAD_MAX_MEMORY_SIZE = 512 * 1024 * 1024  # 512 MB
